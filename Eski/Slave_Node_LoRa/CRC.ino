//BLACK_BOX CRC_16 MODBUS code.
uint16_t generate_CRC_16_bit(uint8_t number_of_bytes, uint8_t B_0, uint8_t B_1, uint8_t B_2, uint8_t B_3, uint8_t B_4, uint8_t B_5, uint8_t B_6) {
  ...
  if (number_of_bytes >= 7 )  remainder = CRC_16_bit_for_1BYTE(B_6, remainder);
  return remainder;
}
//BLACK_BOX CRC_16Bit algorithm
